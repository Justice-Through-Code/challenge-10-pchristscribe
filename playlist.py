...
'''
song_dict_1 = {'artist': 'Pearl Jam', 'title': 'Black'}
add_song(my_playlist, song_dict_1)
...
song_dict_2 = {'artist': "P!nk", 'title': 'Glitter in the Air'}
song_dict_3 = {'artist': "Madonna", 'title': "Like a Virgin"}
add_song(my_playlist, song_dict_2)
add_song(my_playlist, song_dict_3)
...
avg = get_playlist_length(my_playlist)
print(avg)
